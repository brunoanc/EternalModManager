...
public partial class AdvancedWindow : Window
{
    ...
    public static async Task ShowWindowAsync(Window parent)
    {
    ...
    private async void RestoreBackups(object? sender, RoutedEventArgs e)
    {
        ...
        // Show success info window
        await MessageBox.ShowAsync(this, MessageBox.MessageType.Information, $"{restoredBackups} backups were restored.",
    ...
    {
        // Ask for confirmation
        var result = await MessageBox.ShowAsync(this, MessageBox.MessageType.Warning,
        ...
        // Show success info window
        await MessageBox.ShowAsync(this, MessageBox.MessageType.Information, $"{deletedBackups} backups were deleted.",
            MessageBox.MessageButtons.Ok);
    }
