...
public class MainWindowViewModel : ViewModelBase
{
    ...
    private bool IsModOnlineSafe(string modPath)
    {
        ...
        {
            string modFileEntry = modFile.FullName.ToLower(new CultureInfo("en-US", false));
            ...
            if (_onlineSafeModNameKeywords.All(keyword => modName.Contains(keyword)) && isModifyingUnsafeResouce)
            {
                return false;
            }
        }
        ...
        foreach (var assetsInfoEntry in assetsInfoJsons)
        {
            ...
            string assetsInfoJson = reader.ReadToEnd();
    ...
    private void LoadModIntoList(string modFile, bool isEnabled, bool onlyLoadOnlineSafe, List<ModInfo> bufferModList)
    {
        ...
        try
        {
            ...
            if (eternalModJsonEntry != null)
            {
                ...
                string eternalModJson = reader.ReadToEnd();
    ...
    public MainWindowViewModel()
    {
        ...
        DeleteCommand = ReactiveCommand.CreateFromTask(async () =>
        {
            ...
            var result = await MessageBox.ShowAsync((Application.Current.ApplicationLifetime as ClassicDesktopStyleApplicationLifetime)!.MainWindow!,
